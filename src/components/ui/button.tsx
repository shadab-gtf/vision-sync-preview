  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        secondary: "border border-white/10 bg-white/[0.06] text-foreground hover:border-white/20 hover:bg-white/[0.09]",
        ghost: "text-muted-foreground hover:bg-white/[0.06] hover:text-foreground",
        outline: "border border-white/12 bg-transparent text-foreground hover:bg-white/[0.06]"
      },
      size: {
        default: "h-11 px-5",
        sm: "h-9 px-4 text-xs",
